...
--------------------------------------------------------------------------<!--*/
#ifndef NIC_2EA7280F1FC90DED_NIC
#define NIC_2EA7280F1FC90DED_NIC
...
//------------------------------------------------------------------------------
template <class I, class O>
inline O move(I first, I last, O dest)
{
    return move_impl<I, O>::apply(first, last, dest);
}
...
#endif // NIC_2EA7280F1FC90DED_NIC