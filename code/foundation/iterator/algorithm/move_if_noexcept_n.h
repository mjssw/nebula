...
--------------------------------------------------------------------------<!--*/
#ifndef NIC_5DF7F06B5A177E22_NIC
#define NIC_5DF7F06B5A177E22_NIC
...
struct move_if_noexcept_n_impl
{
private:
...
inline O move_if_noexcept_n(I first, const Size &n, O dest)
{
    return move_if_noexcept_n_impl<I, O>::apply(first, n, dest);
}
...
#endif // NIC_5DF7F06B5A177E22_NIC
