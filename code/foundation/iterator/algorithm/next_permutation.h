...
--------------------------------------------------------------------------<!--*/
#ifndef NIC_6886882093597812_NIC
#define NIC_6886882093597812_NIC
...
inline bool next_permutation(I first, I last, F &&f = F())
{
    return next_permutation_impl<I>::apply(first, last, f);
}
...
#endif // NIC_6886882093597812_NIC
