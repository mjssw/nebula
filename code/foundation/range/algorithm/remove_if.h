...
--------------------------------------------------------------------------<!--*/
#ifndef NIC_1B1F47617A82418F_NIC
#define NIC_1B1F47617A82418F_NIC
...
struct remove_if_impl
{
    ...
    apply(R_ &&r, F_ &&f)
    {
        return ins_::remove_if(range::begin(r), range::end(r), f);
    }
};
//------------------------------------------------------------------------------
/**
...
#endif // NIC_1B1F47617A82418F_NIC
