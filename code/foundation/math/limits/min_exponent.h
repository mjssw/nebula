...
--------------------------------------------------------------------------<!--*/
#ifndef NIC_78AD1707D874512F_NIC
#define NIC_78AD1707D874512F_NIC
...
//------------------------------------------------------------------------------
template <class T>
inline constexpr typename exponent<T>::type min_exponent() noexcept
{
    return min_exponent_impl<T>::apply();
}
...
#endif // NIC_78AD1707D874512F_NIC