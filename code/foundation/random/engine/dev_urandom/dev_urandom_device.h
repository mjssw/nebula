...
--------------------------------------------------------------------------<!--*/
#ifndef NIC_8FBB8900484D1EA3_NIC
#define NIC_8FBB8900484D1EA3_NIC
...
/** @ingroup Foundation
  ...
  * */
//------------------------------------------------------------------------------
class n_foundation_dll dev_urandom_device : public io::stream_base
{
public:
    ...
    inline void swap(dev_urandom_device &other) noexcept {
...
#endif // NIC_8FBB8900484D1EA3_NIC
