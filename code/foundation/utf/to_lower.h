...
--------------------------------------------------------------------------<!--*/
#ifndef NIC_E3A960829EE7ADE0_NIC
#define NIC_E3A960829EE7ADE0_NIC
...
struct to_lower_impl
{
    ...
    {
        #ifdef N_UTF_unistring
        unistring::to_lower(s.data(), range::size(s), iso639_lang, nf, out);
        #endif
    }
};
//------------------------------------------------------------------------------
...
inline void to_lower(
    ...
    OutString &out)
{
    return to_lower_impl<InString>::apply(s, iso639_lang, nf, out);
}
...
#endif // NIC_E3A960829EE7ADE0_NIC
